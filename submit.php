            ...
            if(isset($_POST["submit"])) {
				...
				if ($uploadOk == 1)
				{
					...
					else
					{
						...
						$sql="INSERT INTO perusahaan(nama_perusahaan, cp_perusahaan, telpon_perusahaan, alamat_perusahaan, status, aktif)
					...
					$sql = "INSERT INTO lamaran(id_lamaran,google_id,nim,nama,no_kontak,sks,id_perusahaan,job_desc,tipe) VALUES('$id_lamaran','$g_id','$nim','$nama','$telp','$sks','$id_perusahaan','$jobdesc','$type')";
					$conn->query($sql);
