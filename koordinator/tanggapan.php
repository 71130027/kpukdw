...
?>
 ...
 <div id="download">
    ...
    <br><br>
    <?php
    echo "<td><a href='terimalamaran.php?id=".$query2['id_lamaran']."'><button>Accept</button></a></td></font></td>";
    echo "<pre> </pre>";
    echo "<td><a href='tolaklamaran.php?id=".$query2['id_lamaran']."'><button>Decline</button></a></td></font></td>";
    ?>
    </div>
  </div>
  </div>
