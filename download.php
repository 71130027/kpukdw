...
include('koneksi.php');
$id = $_SESSION['id'];
$sql = "SELECT id_lamaran, nim, nama, job_desc, nama_perusahaan, telpon_perusahaan, alamat_perusahaan, cp_perusahaan 
...
$pdf->Cell(30,8,'No.Telepon/HP',0,0,'L'); $pdf->Cell(0,8,': ',0,1,'L');
$pdf->Cell(30,8,'Program Studi',0,0,'L'); $pdf->Cell(0,8,': ',0,1,'L');
$pdf->Cell(0,8,'',0,1,'L');
